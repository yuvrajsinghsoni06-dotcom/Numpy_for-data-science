...
# random number - It is used for general modeling or test purposes. It also comprises a seed, which is used to produce the same results every time it is called. 

# np.random.default_rng(seed =1)
# # print(rng.integers(low = 1, high = 4, size=(3,2)))


# np.random.seed(seed =1)
# print(np.random.uniform(low= -1, high = 1 ,size=(2,2)))  # unifrom function returns a random floating number betwen defined range
